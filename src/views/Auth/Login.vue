...
<template>
  <ion-page>
    ...
    <ion-content>
      ...
      <div class="buttons">
        <ion-button expand="block" :routerLink="{ name: 'home' }"
          >Log in</ion-button
        >
        <ion-button
          color="light"
          expand="block"
          :routerLink="{ name: 'signup' }"
        >
          Create an account
        </ion-button>
      </div>
      ...
      <div class="buttons">
        <SocialMediaAuth title="Login with" />
      </div>
    </ion-content>
  </ion-page>
</template>
...
import SocialMediaAuth from "@/components/Auth/SocialMedia.vue";
